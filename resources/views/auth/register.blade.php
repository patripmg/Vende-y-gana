                ...
                <div class="d-flex flex-column align-items-center ">
                    <div class="form-content justify-content-center mb-5 pb-5">
                        ...
                        <div class="section-title">
                            ...
                            <!-- <p>Ut possimus qui ut temporibusculpa velit autem.</p> -->
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                        <!--FORM FIELDS -->
                        <form action="/register" method="POST" rol e="form" class="php-email-form">
                            @csrf
                            <!--Name -->
                            <div class="form-field-edit form-fieldspace-around my-2">
                            ...
                            <!--Email -->
                            <div class="form-field-edit form-fieldspace-around my-2">
                                <input type="email" name="email" i d="email" class="form-control forms_field-input"
                                    placeholder="Tu correo" data-r ule="minlen:4"
                            ...
                            <div class="form-field-edit form-field space-around my-2">
                                <input type="password" name="password_confirmation" id="password" class="form-control forms_field-input" placeholder="Tu contraseña, una vez más">
                                <div class="validate"></div>
                            </div>
                            <!--Button-Register-->
                    ...
                    <div class="form-link mt-4 d-flex">
                        <p class="text-white">¿Ya eres de los nuestro
                            s?</p>
                        <a class="text-reset text-decoration-none ps2" href="{{route('login')}}"><u>¡Entra ya!</u></a>
                    </div>
                </div>
            </div>
        </div>
