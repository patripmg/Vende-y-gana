    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3">
                <!--FORM TITLE -->
                <h2 class="form-title space-around">Iniciar se
                    sión</h2>
                @if ($errors->any())
                ...
                <p class="my-3">¿Aún no eres de los nuestros?
                    <a class="btn btn-info btn-sm ms-2" href="{{route('register')}}">¡Registrate!</a> </p>
            </div>
        </div>
    </div>
